...
阶段 3 为首版战斗建立统一、可复现的随机种子链，覆盖怪物生成位置、怪物实例生命、玩家攻击、怪物攻击和掉落。装备池、怪物池、标签和词条扩充仍留在阶段 4。
...
装备伤害快照见 [装备系统](./equipment-system.md)，伤害计算与词条语义见 [伤害系统与词条系统设计](./damage-affix-system.md)。
