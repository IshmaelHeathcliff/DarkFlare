...
- alpha 0.1.7 历史封板基线：12 个顶层类型、7 个嵌套类型，共 19 类、163 个序列化字段；后续模块已扩展，当前覆盖结果以反射扫描为准；
...
旧 [标签配置参考](./combat-tags.md) 与 [角色、物品与攻击配置参考](./combat-content.md) 保留为阶段迁移摘要；新增或修改字段维护上表对应模块合同。
