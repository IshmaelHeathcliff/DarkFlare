...
“内容校验”页提供重新扫描、错误 / 警告计数、问题资产路径与原因，并支持直接打开或定位资产。当前校验覆盖标签 Domain / 使用状态 / 查询作用域、词条、装备、怪物、刷怪、掉落、商店、打造和 Addressable Prefab；也会拒绝强类型字段已经能够派生却仍被手填的标签。正式内容提交前应保持结果为空。
